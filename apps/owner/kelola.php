...
<body class="bg-gray-100 flex flex-col h-screen">
        ...
        <main class="relative z-20 -mt-20 px-6">
            <section class="bg-white rounded-lg shadow-md p-5">
                <div class="flex items-center space-x-4 border-b pb-4">
                    <img src="https://placehold.co/64x64/EFEFEF/333333?text=Logo" alt="Logo Usaha" class="w-16 h-16 rounded-lg">
                    <div>
                        <h2 class="text-xl font-bold text-gray-900">BersihXpress</h2>
                        <p class="text-sm text-gray-500">Jl Re Martadinata Kuningan</p>
                    </div>
                </div>
                <div class="flex justify-around text-center pt-4">
                    <div>
                        <p class="text-xl font-bold text-gray-900">280</p>
    ...
    <div id="modal-container" class="hidden z-30">
        ...
        <div id="modal-profil-usaha" class="modal-popup fixed bottom-0 left-0 right-0 bg-white rounded-t-[24px] shadow-2xl z-50 flex flex-col h-[90vh]">
            ...
            <div class="flex-grow overflow-y-auto p-6 no-scrollbar">
                <form id="form-profil-usaha" class="space-y-4" method="POST" action="/owner/form-profil-usaha.php">
                    
                    <div class="bg-white border border-gray-200 rounded-lg p-5 space-y-4">
                        <div>
                            <label for="nama_usaha" class="text-sm font-medium text-gray-600">Nama Usaha Laundry</label>
                            <div class="relative mt-1">
                                ...
                                <input type="text" id="nama_usaha" name="nama_usaha" class="w-full pl-10 pr-3 py-3 border border-gray-300 rounded-lg" placeholder="Nama Usaha Laundry">
                            </div>
                        </div>
                        
                        <div>
                            <label for="no_handphone" class="text-sm font-medium text-gray-600">No Handphone</label>
                            <div class="relative mt-1">
                                ...
                                <input type="tel" id="no_handphone" name="no_handphone" class="w-full pl-10 pr-3 py-3 border border-gray-300 rounded-lg" placeholder="No Handphone">
                            </div>
                        </div>
                        ...
                        <div>
                            <label for="alamat_usaha" class="text-sm font-medium text-gray-600">Alamat Usaha Laundry</label>
                            <div class="relative mt-1">
                                ...
                                <textarea id="alamat_usaha" name="alamat_usaha" rows="3" class="w-full pl-10 pr-3 py-3 border border-gray-300 rounded-lg" placeholder="Contoh : Jln Re Martadinata"></textarea>
                            </div>
                        </div>
                    </div>
                </form>
            ...
            <div class="flex-shrink-0 p-6 bg-white border-t border-gray-200">
                <button type="submit" form="form-profil-usaha" class="w-full bg-blue-600 text-white font-bold py-3 px-4 rounded-lg hover:bg-blue-700">
                    Simpan Perubahan
                </button>
            </div>
        </div>
