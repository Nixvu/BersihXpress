...
<head>
    ...
    <script src="../../assets/js/owner-transaksi.js" defer></script>
</head>
...
<body class="bg-gray-100 flex flex-col h-screen">
                ...
                <div class="flex justify-between items-start">
                    <div class="flex items-center">
                        ...
                        <div>
                            ...
                            <p class="text-lg font-bold text-gray-900">Siti</p>
                        </div>
                    </div>
                    <div>
                        <p class="text-lg font-bold text-gray-900 text-right">Rp 42.000</p><span
                            class="text-xs font-semibold bg-blue-100 text-blue-700 rounded-full px-2 py-0.5">Diproses</span>
                    </div>
                </div>
                <div class="border-t border-dashed mt-3 pt-3 text-sm text-gray-500">
                    <p>Masuk : 21/11/2025 - 14:00</p>
                    <p>Selesai : 1 Hari lagi</p>
                </div>
            </button>
        </main>
    </div>
    ...
    <nav
        ...
        <a href="kelola.php" class="flex flex-col items-center text-gray-500 px-4 py-2"><svg data-feather="grid"
                class="w-6 h-6"></svg><span class="text-xs mt-1">Kelola</span></a>
        <a href="transaksi.php" class="flex flex-col items-center text-blue-600 bg-blue-100 rounded-lg px-4 py-2"><svg
                data-feather="file-text" class="w-6 h-6"></svg><span class="text-xs mt-1">Transaksi</span></a>
        <a href="dashboard.php" class="flex flex-col items-center text-gray-500 px-4 py-2"><svg data-feather="home"
                class="w-6 h-6"></svg><span class="text-xs mt-1">Beranda</span></a>
        <a href="laporan.php" class="flex flex-col items-center text-gray-500 px-4 py-2"><svg
                data-feather="bar-chart-2" class="w-6 h-6"></svg><span class="text-xs mt-1">Laporan</span></a>
        <a href="profile.php" class="flex flex-col items-center text-gray-500 px-4 py-2"><svg data-feather="user"
                class="w-6 h-6"></svg><span class="text-xs mt-1 font-semibold">Akun</span></a>
    </nav>
