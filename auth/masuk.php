        ...
        <div class="w-full max-w-md bg-white rounded-2xl shadow-lg p-6">
            ...
            <form id="loginForm" class="space-y-4">
                ...
                <div class="flex items-center justify-end">
                    <a href="email.php" class="text-sm text-blue-600 hover:text-blue-700">Lupa kata sandi?</a>
                </div>
            ...
            <div class="mt-6 text-center">
                <p class="text-gray-600">
                    Belum punya akun?
                    <a href="daftar.php" class="text-blue-600 hover:text-blue-700 font-medium">Daftar sekarang</a>
                </p>
            </div>
        </div>
    </main>
