...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function completeOnboardingAndNavigate(pageUrl) {
        // (Komentar) Path ini mengasumsikan onboarding.html ada di root
        const basePath = 'auth/';

        if (window.Android && typeof window.Android.onboardingFinished === 'function') {
            window.Android.onboardingFinished();
        }
    ...
    btnRegister.addEventListener('click', () => {
        completeOnboardingAndNavigate('daftar.html');
    });

    btnLogin.addEventListener('click', () => {
        completeOnboardingAndNavigate('masuk.html');
    });
